...
Testimonial slider is responsive WordPress testimonial showcase plugin. It come with many options allow you to display testimonials in four different ways.

Testimonial slider plugin allows you to filter testimonials by categories. 


Let your clients submit testimonials via frontend Ajax form. After submission testimonials can be set pending until you approve them in WordPress admin in easy to use testimonial management.
